...
public class StringLesson {
        ...
        public static void main(String[] args) {
            ...
            String string01 = "Cat";
            String string02 = "Cat";
            String string03 = new String("Cat"); //создание строки через конструктор, и не в памяти pool
            //его использовать если иначе никак, лучше использовать по возм-ти ""

            //
            System.out.println(string01.length());

            // Сравнение ссылок
            System.out.println(string01 == string02); // true оба в пул памяти
            System.out.println(string01 == string03); // false, один в пуле, другой в стринге памяти

            // сравнение строк
            string01 = "Строка";
            string02 = "строка";
            if (string01.equals(string02)) System.out.println("Строки равны"); //посимвольноетсравнение методом equals
            if (string01.equalsIgnoreCase(string02)) System.out.println("Строки равны без учета регистра"); //сравнивает без учета регистра

            if (string01.compareTo(string02) < 0) { // или compareToIgnoreCase - без учета регистра, метод вернет 0, если равны, сравнивает по таблице юникода
            ...
            // переданным в качестве параметра, и возвращает в результате
            // выполнения сравнения целое число

            // верхний и нижний регистр
            string01 = " JaVa ";
            string02 = " deVEloPEr ";
            String upperString = string01.toUpperCase();  //метод приведения к верхнему регистру
            String lowerString = string02.toLowerCase(); //метод привидения к нижнему регистру
            ...
            String[][] matrix02 = {
                    {"open", "close", "process"},
                    {"close", "close", "process"},
                    {"process", "close", "close"}   //массив на 3 эл-та, вложенный
            };

            System.out.println(matrix02[1][1]); // чтобы вывести клоус со второго вложен массива строки
            System.out.println(Arrays.deepToString(matrix01)); // распечатает массив многомерный

            String[][] animals = new String[3][]; // [null, null, null] массив с дефолтными значениями
            ...
            int count = 0;
            double rating = 5.5;
            //Товар: Книга. На складе: 0шт. Рейтинг: 5.5 - такую строку хотим получить
